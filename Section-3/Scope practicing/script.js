...
function calcAge(birthYear) {
  ...
  function printAge() {
    ...
    if (birthYear >= 1981 && birthYear <= 1996) {
      ...
      const firstName = 'Steven'; //js look the variable name in the current scope so changed jonas to steven
    ...
    add(2, 3); //not defined, functions are block scoped, only true for strict mode
...
calcAge(1991);
console.log(age); //outer scope can't have acces to inner scope, but inner scope can have acces to outer scope

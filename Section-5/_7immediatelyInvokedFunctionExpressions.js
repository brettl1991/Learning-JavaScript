...
//immediately onvoked function expression
...
//this is a eason why iife are not is common use nowdays because if we want to create a scope for our data we can put it in a block like below
{
  const isPrivate = 23;
}
